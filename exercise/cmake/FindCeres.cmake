...
# source: https://github.com/cdcseacave/openMVS/blob/master/build/Modules/FindCERES.cmake
...
if(NOT EXISTS "${CERES_DIR}")
	find_path(CERES_DIR "CeresConfig.cmake"
			...
			PATHS "$ENV{PROGRAMFILES}" "$ENV{PROGRAMW6432}" "/usr" "/usr/local" "/usr/share" "/usr/local/share" "/usr/lib/cmake" "/usr/local/lib/cmake" "/usr/include" "/usr/lib/x86_64-linux-gnu/cmake" "../../../ceres-solver/build"
			PATH_SUFFIXES "Ceres"
